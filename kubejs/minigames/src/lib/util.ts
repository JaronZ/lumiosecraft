...
(function() {
    ...
    global.lcminigames.pickRandom = function(list: unknown[]) {
    ...
    global.lcminigames.shuffle = function(array: unknown[]) {
    ...
    global.lcminigames.centeredMessage = function(msg: string){
    ...
    global.lcminigames.createChatFrame = function(title: string, content: $Component$$Type | $Component$$Type[]) {
        return Text.join(
    ...
    global.lcminigames.findVal = function(obj: NonNullable<unknown>, prop: string, defaultValue: unknown) {
     ...
     * @returns {any[]}
     */
    global.lcminigames.flatArray = function(array: unknown[], depth: number = 1): unknown[] {
